...
using AspNetCoreSPA.Framework.Extensions;
...
namespace AspNetCoreSPA.Framework.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new ApplicationException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new ApplicationException("Complete is called before!");
            }
        ...
        private void SetFilters(List<DataFilterConfiguration> filterOverrides)
        {
            ...
            //if (!TpsSession.UserId.HasValue || TpsSession.MultiTenancySide == MultiTenancySides.Host)
            //{
            //    ChangeFilterIsEnabledIfNotOverrided(filterOverrides, TpsDataFilters.MustHaveTenant, false);
            //}
        }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new ApplicationException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
